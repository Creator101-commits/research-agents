...
DASHBOARD_ECONOMICS_FIELDS = (
    ...
    "disease_economic_cost",
    "cooling_cost",
    "processor_energy_cost_not_in_profit",
    "labor_cost",
    "fixed_cost",
    "total_cost",
    "profit",
...
_ECONOMICS_METRICS: dict[str, tuple[str, str, str]] = {
    ...
    "processor_energy_cost_not_in_profit": ("processor_energy_cost_not_in_profit", "currency", "sum"),
        ...
        result.append(
            {
                ...
                "processor_energy_cost_not_in_profit": deepcopy(source.get("processor_energy_cost_not_in_profit")),
