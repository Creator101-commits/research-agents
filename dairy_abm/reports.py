...
REPORT_CONTRACT = {
    "daily": {
        ...
        "fields": {
            ...
            # Farm ledger: workbook herd economics plus the itemized loop layer.
            "feed_cost": "currency/day (workbook feed charge minus loop feed saving)",
            "workbook_feed_cost": "currency/day",
            "loop_feed_saving": "currency/day",
            "purchased_feed_cost": "currency/day",
            "herd_revenue": "currency/day",
            "herd_cost": "currency/day",
